...
The deployment url is: [https://arquisoft.github.io/yovi_es1a/](https://arquisoft.github.io/yovi_es1a/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/yovi_es1a/](https://arquisoft.github.io/yovi_es1a/), we need to execute `npm run deploy`.
