...
= image:yovi_logo.png[Logo Yovi, width=60] Game Y : yovi_es1a
:revnumber: 3.0 EN
:revdate: April 2026
...
<<<<
// 12. Testing Methods
include::src/12_testing_methods.adoc[]

<<<<
// 13. Monitoring and API documentation
include::src/13_monitoring_and_API_documentation.adoc[]
