...
** **Data Persistence Interface:** The Users Service communicates directly with the internal MongoDB database to read and write persistent data (user profiles and game history). This connection is strictly internal to the backend environment.