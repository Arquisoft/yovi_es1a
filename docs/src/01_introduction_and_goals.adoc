...
- **Game Mechanics:** Provide a functional version of the strategic game with a variable hexagonal board, including advanced match controls such as undoing moves, passing turns, and surrendering.

- **Platform:** Available as a responsive web application.

- **Game Modes:** Offer multiplayer capabilities as well as a single-player mode against a computer bot.
...
| The system should be intuitive for users to learn and play. It must include clear UI feedback (e.g., turn indicators, neon glow effects) and consider basic accessibility standards so a wider range of users can enjoy the experience.
